...
{
    /// <summary>
    /// Within the package there may be one guide element, containing one or more reference elements. The 
    /// guide element identifies fundamental structural components of the publication, to enable Reading 
