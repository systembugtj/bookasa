...
{
    /// <summary>
    /// Following the manifest there must be one spine element, which defines the primary linear 
    /// reading order of the publication. It specifies an ordered list of one or
    /// more OPS Content Documents drawn from the manifest, using itemref elements contained within the
    /// spine element.
    /// </summary>
    public class Spine
    {
