...
namespace Crimson.Catalog.Services.Library
{
    ...
    {
        [OperationContract]
        List<LibraryCatalog> GetCatalogs();

        #region Book Searches
        [OperationContract]
        ...
        [OperationContract]
        List<Book> GetBooksByCreator(string creator);

        [OperationContract]
        List<Book> GetBooksByTitleAndCreator(string title, string creator);
        #endregion
   }
}