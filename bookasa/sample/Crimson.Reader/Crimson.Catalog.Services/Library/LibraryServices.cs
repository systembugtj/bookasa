...
namespace Crimson.Catalog.Services.Library 
{
    ...
    {
        #region ILibraryServices Members
        public List<LibraryCatalog> GetCatalogs()
        {
        ...
        public List<Book> GetBooksByCreator(string creator)
        {
            throw new NotImplementedException();
        }

        public List<Book> GetBooksByTitleAndCreator(string title, string creator)
        {
            throw new NotImplementedException();
        }
        #endregion
