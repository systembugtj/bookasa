...
{
    [ServiceContract]
    public interface ICrimsonCatalog
    {
        [OperationContract]
        List<CrimsonCatalog> GetCatalog();

        [OperationContract]
        void CreateCatalog(CrimsonCatalog catalog);

        [OperationContract]
        void DeleteCatalog(CrimsonCatalog catalog);

        [OperationContract]
        void UpdateCatalog(CrimsonCatalog catalog);
    }
}