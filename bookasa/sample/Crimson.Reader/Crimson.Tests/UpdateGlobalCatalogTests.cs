...
{
    [TestFixture]
    public class UpdateGlobalCatalogTests
    {
        ...
        {
            Crimson.Catalog.Gutenberg.Catalog catalog = new Crimson.Catalog.Gutenberg.Catalog() 
                { LocalCatalog = GlobalCatalog };
            catalog.UpdateCatalogs();
        }

        [Test]
        public void AuthorSearchTest()
        {
            var TwainBooks = (from books in GlobalCatalog.BookCreators
        ...
        {
            var SkylarkBook = (from books in GlobalCatalog.Books
        ...
        {
            var SkylarkBook = (from ebook in GlobalCatalog.Books
                               join bookcreator in GlobalCatalog.BookCreators on
        ...
        {
            var Created2007 = (from books in GlobalCatalog.Books
