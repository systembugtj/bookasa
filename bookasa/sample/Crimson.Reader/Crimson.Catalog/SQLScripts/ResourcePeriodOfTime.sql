...
IF  EXISTS (SELECT * 
			FROM sys.objects 
			WHERE object_id = OBJECT_ID(N'[DublinCore].[ResourcePeriodOfTime]') AND type in (N'U'))
 ...
 */ 
CREATE TABLE [DublinCore].[ResourcePeriodOfTime](
	[ResourceId] [uniqueidentifier] NOT NULL,
	PeriodOfTimeId [uniqueidentifier] NOT NULL,
 CONSTRAINT [PK_ResourcePeriodOfTime] PRIMARY KEY CLUSTERED 
(
	ResourceId ASC,
	PeriodOfTimeId ASC
...
EXEC sys.sp_addextendedproperty 
	...
	@value=N'A Period of Time for a Resource.', 
	@level0type=N'SCHEMA',
	@level0name=N'DublinCore', 
	@level1type=N'TABLE',
	@level1name=N'ResourcePeriodOfTime'
GO
EXEC sys.sp_addextendedproperty 
	@name=N'MS_Description', 
...
EXEC sys.sp_addextendedproperty 
	@name=N'MS_Description', 
	@value=N'The unique Identifer for the ResourcePeriodOfTime.' , 
	@level0type=N'SCHEMA',
	@level0name=N'DublinCore', 
	@level1type=N'TABLE',
	@level1name=N'ResourcePeriodOfTime',
...
GRANT SELECT, INSERT, UPDATE, DELETE 
	ON [DublinCore].[ResourcePeriodOfTime]
