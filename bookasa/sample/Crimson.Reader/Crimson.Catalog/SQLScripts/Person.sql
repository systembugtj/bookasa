...
IF  EXISTS (SELECT * 
			FROM sys.objects 
			WHERE object_id = OBJECT_ID(N'[DublinCore].[Person]') AND type in (N'U'))
DROP TABLE [DublinCore].[Person]
GO
/*
 * Agent of Type Person
 * See http://purl.org/dc/terms/Agent 
 */ 
CREATE TABLE [DublinCore].[Person](
