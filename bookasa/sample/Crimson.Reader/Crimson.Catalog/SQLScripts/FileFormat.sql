...
IF  EXISTS (SELECT * 
			FROM sys.objects 
			WHERE object_id = OBJECT_ID(N'[DublinCore].[FileFormat]') AND type in (N'U'))
DROP TABLE [DublinCore].[FileFormat]
GO
/*
 * A digital resource format.
 * See http://purl.org/dc/terms/FileFormat 
 */ 
CREATE TABLE [DublinCore].[FileFormat](
	[FileFormatId] [uniqueidentifier] NOT NULL,
...
EXEC sys.sp_addextendedproperty 
	...
	@value=N'A digital resource format.' , 
	@level0type=N'SCHEMA',
	@level0name=N'DublinCore', 
	@level1type=N'TABLE',
	@level1name=N'FileFormat'
GO
EXEC sys.sp_addextendedproperty 
	@name=N'MS_Description', 
	@value=N'The unique Identifer for the FileFormat.' , 
	@level0type=N'SCHEMA',
	@level0name=N'DublinCore', 
	@level1type=N'TABLE',
	@level1name=N'FileFormat',
	@level2type=N'COLUMN',
	@level2name=N'FileFormatId'
GO
/*
 * Grant the table permissions 
 */
GRANT SELECT, INSERT, UPDATE, DELETE 
	ON [DublinCore].[FileFormat]
