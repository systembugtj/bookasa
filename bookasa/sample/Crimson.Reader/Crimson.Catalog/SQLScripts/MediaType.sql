...
IF  EXISTS (SELECT * 
			FROM sys.objects 
			WHERE object_id = OBJECT_ID(N'[DublinCore].[MediaType]') AND type in (N'U'))
DROP TABLE [DublinCore].[MediaType]
GO
/*
 * Location, Period, or Jurisdiction
 * See http://purl.org/dc/terms/MediaType 
 */ 
CREATE TABLE [DublinCore].[MediaType](
...
EXEC sys.sp_addextendedproperty 
	...
	@value=N'A file format or physical medium.', 
	@level0type=N'SCHEMA',
...
EXEC sys.sp_addextendedproperty 
	@name=N'MS_Description', 
	@value=N'The unique Identifer for the MediaType.' , 
	@level0type=N'SCHEMA',
	@level0name=N'DublinCore', 
	@level1type=N'TABLE',
	@level1name=N'MediaType',
