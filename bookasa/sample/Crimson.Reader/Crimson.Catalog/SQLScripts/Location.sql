...
IF  EXISTS (SELECT * 
			FROM sys.objects 
			WHERE object_id = OBJECT_ID(N'[DublinCore].[Location]') AND type in (N'U'))
DROP TABLE [DublinCore].[Location]
GO
/*
 * A spatial region or named place.
 * See http://purl.org/dc/terms/Location 
 */ 
CREATE TABLE [DublinCore].[Location](
...
EXEC sys.sp_addextendedproperty 
	...
	@value=N'A spatial region or named place.', 
	@level0type=N'SCHEMA',
...
EXEC sys.sp_addextendedproperty 
	@name=N'MS_Description', 
	@value=N'The unique Identifer for the Location.' , 
	@level0type=N'SCHEMA',
	@level0name=N'DublinCore', 
	@level1type=N'TABLE',
	@level1name=N'Location',
