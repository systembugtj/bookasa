...
IF  EXISTS (SELECT * 
			FROM sys.objects 
			WHERE object_id = OBJECT_ID(N'[DublinCore].[Agent]') AND type in (N'U'))
 ...
 */ 
CREATE TABLE [DublinCore].[Agent](
	[AgentId] [uniqueidentifier] NOT NULL,
	[Name] NVARCHAR(50) NOT NULL,
	[FileAs] NVARCHAR(50) NOT NULL
...
EXEC sys.sp_addextendedproperty 
	...
	@value=N'A resource that acts or has the power to act.' , 
	@level0type=N'SCHEMA',
...
EXEC sys.sp_addextendedproperty 
	@name=N'MS_Description', 
	@value=N'The sortable name of the agent.' , 
	@level0type=N'SCHEMA',
	@level0name=N'DublinCore', 
	@level1type=N'TABLE',
	@level1name=N'Agent',
...
GO
INSERT INTO [DublinCore].[Agent]([AgentId], [Name], [FileAs])
VALUES
(NEWID(), 'Project Gutenberg Literary Archive Foundation', 'PROJECT GUTENBERG'),
(NEWID(), 'The Library of Congress', 'LIBRARY OF CONGRESS')
