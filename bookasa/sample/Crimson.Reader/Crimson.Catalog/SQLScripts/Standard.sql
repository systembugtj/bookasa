...
IF  EXISTS (SELECT * 
			FROM sys.objects 
			WHERE object_id = OBJECT_ID(N'[DublinCore].[Standard]') AND type in (N'U'))
DROP TABLE [DublinCore].[Standard]
GO
/*
 * A basis for comparison; a reference point against which other things can be evaluated.
 * See http://purl.org/dc/terms/Standard 
 */ 
CREATE TABLE [DublinCore].[Standard](
...
EXEC sys.sp_addextendedproperty 
	...
	@value=N'A basis for comparison; a reference point against which other things can be evaluated.', 
	@level0type=N'SCHEMA',
	@level0name=N'DublinCore', 
	@level1type=N'TABLE',
	@level1name=N'Standard'
GO
EXEC sys.sp_addextendedproperty 
	@name=N'MS_Description', 
	@value=N'The unique Identifer for the Standard.' , 
	@level0type=N'SCHEMA',
	@level0name=N'DublinCore', 
	@level1type=N'TABLE',
	@level1name=N'Standard',
	@level2type=N'COLUMN',
	@level2name=N'StandardId'
GO
/*
 * Grant the table permissions 
 */
GRANT SELECT, INSERT, UPDATE, DELETE 
	ON [DublinCore].[Standard]
