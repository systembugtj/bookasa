...
IF  EXISTS (SELECT * 
			FROM sys.objects 
			WHERE object_id = OBJECT_ID(N'[DublinCore].[Frequency]') AND type in (N'U'))
DROP TABLE [DublinCore].[Frequency]
GO
/*
 * A rate at which something recurs.
 * See http://purl.org/dc/terms/Frequency 
 */ 
CREATE TABLE [DublinCore].[Frequency](
...
EXEC sys.sp_addextendedproperty 
	...
	@value=N'A rate at which something recurs.' , 
	@level0type=N'SCHEMA',
	@level0name=N'DublinCore', 
	@level1type=N'TABLE',
	@level1name=N'Frequency'
GO
EXEC sys.sp_addextendedproperty 
	@name=N'MS_Description', 
	@value=N'The unique Identifer for the Frequency.' , 
	@level0type=N'SCHEMA',
	@level0name=N'DublinCore', 
	@level1type=N'TABLE',
	@level1name=N'Frequency',
	@level2type=N'COLUMN',
	@level2name=N'FrequencyId'
GO
/*
 * Grant the table permissions 
 */
GRANT SELECT, INSERT, UPDATE, DELETE 
	ON [DublinCore].[Frequency]
