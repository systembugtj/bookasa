...
IF  EXISTS (SELECT * 
			FROM sys.objects 
			WHERE object_id = OBJECT_ID(N'[DublinCore].[Jurisdiction]') AND type in (N'U'))
DROP TABLE [DublinCore].[Jurisdiction]
GO
/*
 * The extent or range of judicial, law enforcement, or other authority.
 * See http://purl.org/dc/terms/Jurisdiction 
 */ 
CREATE TABLE [DublinCore].[Jurisdiction](
...
EXEC sys.sp_addextendedproperty 
	...
	@value=N'The extent or range of judicial, law enforcement, or other authority.' , 
	@level0type=N'SCHEMA',
	@level0name=N'DublinCore', 
	@level1type=N'TABLE',
	@level1name=N'Jurisdiction'
GO
EXEC sys.sp_addextendedproperty 
	@name=N'MS_Description', 
	@value=N'The unique Identifer for the Jurisdiction.' , 
	@level0type=N'SCHEMA',
	@level0name=N'DublinCore', 
	@level1type=N'TABLE',
	@level1name=N'Jurisdiction',
	@level2type=N'COLUMN',
	@level2name=N'JurisdictionId'
GO
/*
 * Grant the table permissions 
 */
GRANT SELECT, INSERT, UPDATE, DELETE 
	ON [DublinCore].[Jurisdiction]
