...
IF  EXISTS (SELECT * 
			FROM sys.objects 
			WHERE object_id = OBJECT_ID(N'[DublinCore].[Relation]') AND type in (N'U'))
DROP TABLE [DublinCore].[Relation]
GO
/*
 * A book, article, or other documentary resource.
 * See http://purl.org/dc/terms/Relation 
 */ 
CREATE TABLE [DublinCore].[Relation](
	[RelationId] [uniqueidentifier] NOT NULL,
	[ConformsTo] [uniqueidentifier]
...
EXEC sys.sp_addextendedproperty 
	@name=N'MS_Description', 
	@value=N'The unique Identifer for the Relation.' , 
	@level0type=N'SCHEMA',
	@level0name=N'DublinCore', 
	@level1type=N'TABLE',
	@level1name=N'Relation',
...
EXEC sys.sp_addextendedproperty 
	@name=N'MS_Description', 
	@value=N'An established standard to which the described resource conforms.', 
	@level0type=N'SCHEMA',
	@level0name=N'DublinCore', 
	@level1type=N'TABLE',
	@level1name=N'Relation',
	@level2type=N'COLUMN',
	@level2name=N'ConformsTo'
GO
/*
 * Grant the table permissions 
 */
GRANT SELECT, INSERT, UPDATE, DELETE 
	ON [DublinCore].[Relation]
